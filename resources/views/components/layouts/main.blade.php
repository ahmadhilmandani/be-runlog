...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Geist+Mono:wght@100..900&family=Tomorrow:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
    <!-- Styles / Scripts -->
        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-neutral-50: oklch(.985 .002 247.839);
                    --color-neutral-100: oklch(.967 .003 264.542);
                    --color-neutral-200: oklch(.928 .006 264.531);
                    --color-neutral-300: oklch(.872 .01 258.338);
                    --color-neutral-400: oklch(.707 .022 261.325);
                    --color-neutral-500: oklch(.551 .027 264.364);
                    --color-neutral-600: oklch(.446 .03 256.802);
                    --color-neutral-700: oklch(.373 .034 259.733);
                    --color-neutral-800: oklch(.278 .033 256.848);
                    --color-neutral-900: oklch(.21 .034 264.665);
                    --color-neutral-950: oklch(.13 .028 261.692);
            ...
            @layer utilities {
                ...
                .\!filter {
                    filter: var(--tw-blur, )var(--tw-brightness, )var(--tw-contrast, )var(--tw-neutralscale, )var(--tw-hue-rotate, )var(--tw-invert, )var(--tw-saturate, )var(--tw-sepia, )var(--tw-drop-shadow, ) !important
                }

                .filter {
                    filter: var(--tw-blur, )var(--tw-brightness, )var(--tw-contrast, )var(--tw-neutralscale, )var(--tw-hue-rotate, )var(--tw-invert, )var(--tw-saturate, )var(--tw-sepia, )var(--tw-drop-shadow, )
                }
    ...
    <div class="w-full min-h-screen">
        <div class="w-full min-h-screen flex">
            <aside id="default-sidebar"
                class="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 border-r border-neutral-200"
                aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-50">
                    <ul class="space-y-2 font-medium">
                        <li class="pb-4 border-b border-neutral-200">
                        ...
                        <li>
                            <a href="{{ route('logs.index') }}"
                                ...
                                {{-- <span
                                    class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-neutral-800 bg-neutral-100   ">Pro</span> --}}
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('tags.index') }}"
                                ...
                                {{-- <span
                                    class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 ">3</span> --}}
                            </a>
                        </li>
                        <li>
                            <a href="#"
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Learning Path</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                    ...
                    <div class="absolute bottom-4 left-4 right-4 flex gap-2 items-center">
                        <div class="flex gap-2 items-center">
                            <div class="rounded-full overflow-hidden size-10 shrink-0">
                                <img
                                    src="https://avatars.laravel.cloud/1d8ef1bc-fc98-498f-8e05-e53521de9d78?vibe=ocean" />
                            </div>
                            <div class="max-w-[160px]">
                                <strong class="line-clamp-1">Ahmad Hilman Dani</strong>
                                <small class="text-neutral-500 line-clamp-1 text-xs">ahmadhilmanlagi@gmail.com</small>
                            </div>
                        </div>
                        <div>
                ...
                <nav class="bg-white border-b border-neutral-200">
                    <div class="flex flex-wrap items-center justify-between p-4">
                        <div class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <div class="pr-1 md:pr-2 border-r border-neutral-200">
                                <i class="ph ph-sidebar-simple text-[18px]"></i>
                            </div>
                        ...
                        <button data-collapse-toggle="navbar-default" type="button"
                            class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded-lg md:hidden hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-neutral-200"
